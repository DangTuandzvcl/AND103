...
import com.example.and1043.Todo.DTO;
                    ...
                    public void onClick(View v) {
                        ...
                        firestore.collection("Car").add(item).addOnSuccessListener(new OnSuccessListener<DocumentReference>() {
                            ...
                            public void onSuccess(DocumentReference documentReference) {
                                Toast.makeText(HomeActivity.this, "Add thành công", Toast.LENGTH_SHORT).show();
                                addInforFirebase();
//                                adapterRecyclerView.notifyDataSetChanged();
                            ...
                            public void onFailure(@NonNull Exception e) {
                                Toast.makeText(HomeActivity.this, "Add thất bại", Toast.LENGTH_SHORT).show();
                                dialog.dismiss();
                                progressDialog.dismiss();
                            }
                        });
    ...
    private void addInforFirebase() {
        ...
        firestore.collection("Car").get().addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
            ...
            public void onFailure(@NonNull Exception e) {
                progressDialog.dismiss();
                Toast.makeText(HomeActivity.this, "Add lỗi", Toast.LENGTH_LONG).show();
            }
        });
    }
}
